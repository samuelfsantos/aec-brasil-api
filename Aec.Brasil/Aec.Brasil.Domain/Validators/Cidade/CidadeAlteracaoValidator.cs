...
{
    public class CidadeAlteracaoValidator : AbstractValidator<Entities.Cidade>, ICidadeAlteracaoValidator
    {
        public CidadeAlteracaoValidator()
        {
            ...
            RuleFor(a => a.IdIntegracao).LessThan(0).WithMessage("O atributo {PropertyName} deve ser maior que 0(zero)");
